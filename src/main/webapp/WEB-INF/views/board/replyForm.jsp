...
<body>
 <h1>답글쓰기</h1>
  <form name="frmReply" method="post"  action="${contextPath}/board/addReply.do?parentNO=${articleNO}"   enctype="multipart/form-data">
    <table>
     <tr>
    	<td>부모</td>
    </tr>	 
    <tr>	
			...
			<td><input type="text" size="20" maxlength="100"  name="writer"  value="${member.name}"></input> </td>
		</tr>
		<tr>
